...
Canvas.image = "images/canvas.jpg"
...
createPageIndicators = (photos) ->
		s.pages.animate opacity: 0
		s.pagesBG.animate opacity: 0
...
s.infoIcon.onTap ->
	slider = s.detail.photosSliders.lastObject()
	infoScreen = slider.content.children[0]
	slider.snapToPage(infoScreen, true)
